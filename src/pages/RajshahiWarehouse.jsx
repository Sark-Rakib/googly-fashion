    ...
    <div>
      <div className="bg-gray-50 border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3">
          <div className="flex items-center gap-2 text-sm text-gray-500">
            ...
            <ChevronRight className="w-3.5 h-3.5" />
            <span className="text-gray-900 font-medium">Rajshahi</span>
          </div>
        </div>
      </div>
      ...
      <section className="bg-gradient-to-r from-[#1F3A63] to-[#2a4d7a] py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-4xl font-bold text-white">Warehouse - Rajshahi</h1>
          <p className="text-white/70 mt-4 max-w-2xl mx-auto">Located in Rajshahi City Center Industrial Area, Rajshahi, Bangladesh.</p>
        </div>
      </section>
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
            <div>
              ...
              <div className="space-y-4">
                {["Regional Distribution", "Storage & Inventory", "Last-mile Delivery (Rajshahi Division)"].map((service) => (
            ...
            <div>
              ...
              <div className="space-y-4">
                {[
                  { icon: Users, text: "40+ staff members" },
                  { icon: Truck, text: "20 delivery vehicles" },
                  { icon: MapPin, text: "Regional hub" },
                ].map(({ icon: Icon, text }) => (
          ...
          <div className="text-center">
            <a
              href="https://maps.google.com/?q=Rajshahi+City+Center+Industrial+Area+Rajshahi+Bangladesh"
              target="_blank"
...
export default RajshahiWarehouse;
