    ...
    <div>
      <div className="bg-gray-50 border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3">
          <div className="flex items-center gap-2 text-sm text-gray-500">
            ...
            <ChevronRight className="w-3.5 h-3.5" />
            <span className="text-gray-900 font-medium">Khulna</span>
          </div>
        </div>
      </div>
      ...
      <section className="bg-gradient-to-r from-[#1F3A63] to-[#2a4d7a] py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-4xl font-bold text-white">Warehouse - Khulna</h1>
          <p className="text-white/70 mt-4 max-w-2xl mx-auto">Situated in Khulna Industrial Belt, Khulna, Bangladesh.</p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
            <div className="bg-white rounded-lg shadow-sm border border-gray-100 p-6">
              ...
              <p className="text-gray-600 text-sm">Khulna Industrial Belt, Khulna, Bangladesh</p>
            </div>
            <div className="bg-white rounded-lg shadow-sm border border-gray-100 p-6">
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-100 p-6">
              ...
              <p className="text-gray-600 text-sm">+880 1700-000005</p>
            </div>
            <div className="bg-white rounded-lg shadow-sm border border-gray-100 p-6">
              <Warehouse className="w-8 h-8 text-[#1F3A63] mb-3" />
              <h3 className="font-semibold text-gray-900 mb-1">Area</h3>
              <p className="text-gray-600 text-sm">30,000 sq ft</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
            <div>
              ...
              <div className="space-y-4">
                {["Regional Distribution", "Cold Storage (Selected Items)", "Standard Shipping"].map((service) => (
            ...
            <div>
              ...
              <div className="space-y-4">
                {[
                  { icon: Users, text: "50+ staff members" },
                  { icon: Truck, text: "25 delivery vehicles" },
                  { icon: MapPin, text: "Strategic southern location" },
                ].map(({ icon: Icon, text }) => (
          ...
          <div className="text-center">
            <a
              href="https://maps.google.com/?q=Khulna+Industrial+Belt+Khulna+Bangladesh"
              target="_blank"
...
export default KhulnaWarehouse;
