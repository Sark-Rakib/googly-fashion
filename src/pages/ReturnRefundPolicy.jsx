  ...
  const process = [
    {
      ...
      desc: "Log into your account and select the item you wish to return.",
    },
    {
      icon: Package,
      step: "2",
      title: "Pack the Item",
      desc: "Pack the item securely with all tags, packaging, and accessories.",
    },
    {
      icon: Truck,
      step: "3",
      title: "Ship It Back",
      desc: "Hand the package to our pickup agent or drop it at a designated center.",
    },
    {
      icon: RefreshCw,
      step: "4",
      title: "Quality Check",
      desc: "We inspect the returned item to ensure it meets our policy criteria.",
    },
    {
      icon: CheckCircle,
      step: "5",
      title: "Refund Initiated",
      desc: "Refund is processed to your original payment method within 5–7 days.",
    },
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-3xl mx-auto mb-16">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="bg-gray-50 rounded-lg p-5 text-center border border-gray-200">
                ...
                <p className="text-2xl font-bold text-[#1F3A63] mt-2">
                  1–2 days
                </p>
          ...
          <div className="max-w-3xl mx-auto mb-16 bg-yellow-50 border border-yellow-200 rounded-lg p-6">
            <p className="text-yellow-800 text-sm leading-relaxed">
              Certain items such as innerwear, swimwear, perishable goods, and
              personalized products are not eligible for return or exchange
              unless they arrive damaged or defective. Sale items may be subject
              to different return conditions as specified at the time of
              purchase.
            </p>
          </div>
          ...
          <div className="max-w-3xl mx-auto text-center bg-gray-50 rounded-xl p-10 border border-gray-200">
            ...
            <p className="text-gray-500 mb-6">
              Ready to return an item? Start the process from your account
              dashboard.
            </p>
            <Link
              to="/dashboard"
              className="inline-block bg-[#EF394E] text-white px-8 py-3 rounded-lg font-medium hover:bg-[#d63243] transition-colors"
            >
              Start a Return
            </Link>
          </div>
